<template>
  <div class="recomentnes">
    <p class="weekss">Riso.S的精心推荐</p>
    <div class="bigAlls">
      <div v-for="(obj,index) in  rrs"  v-on:click="goRecomentnes(index,obj)" class="buyss">
  ...
  export default {
    ...
    created(){
      ...
      axios.get("../../static/data/work.json").then(function (data) {
        arr13.rrs=data.data.InnerData.CEORecommends;
      }).catch(function (err) {
        console.log(err)
      })
    }
